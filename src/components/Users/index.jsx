...
export const Users = ({ items, isLoading, onChangeSearchValue, searchValue, onCliclInvite, invites, onClickSuccess }) => {
  return (
    <>
      ...
      {isLoading ? (
        ...
        <ul className="users-list">
          ...
          }).map(obj => <User onClickInvite={onCliclInvite} isInvited={invites.includes(obj.id)} key={obj.id} {...obj}/>)}
        </ul>
      )}
      {
